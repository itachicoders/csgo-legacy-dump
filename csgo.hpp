...
constexpr uintptr_t dwbSendPackets = 0xDD2D2;
...
constexpr uintptr_t dwEntityList = 0x4E051DC;
constexpr uintptr_t dwForceAttack = 0x3233024;
constexpr uintptr_t dwForceAttack2 = 0x3233030;
constexpr uintptr_t dwForceBackward = 0x3233078;
constexpr uintptr_t dwForceForward = 0x323306C;
constexpr uintptr_t dwForceJump = 0x52C0F50;
constexpr uintptr_t dwForceLeft = 0x3233084;
constexpr uintptr_t dwForceRight = 0x3233090;
constexpr uintptr_t dwGameDir = 0x63AE00;
constexpr uintptr_t dwGameRulesProxy = 0x5334764;
constexpr uintptr_t dwGetAllClasses = 0xE10F84;
constexpr uintptr_t dwGlobalVars = 0x59EE60;
constexpr uintptr_t dwGlowObjectManager = 0x535FCB8;
constexpr uintptr_t dwInput = 0x52627B0;
constexpr uintptr_t dwInterfaceLinkList = 0x99F7D4;
constexpr uintptr_t dwLocalPlayer = 0xDEF97C;
constexpr uintptr_t dwMouseEnable = 0x523E410;
constexpr uintptr_t dwMouseEnablePtr = 0x523E3E0;
constexpr uintptr_t dwPlayerResource = 0x3231380;
constexpr uintptr_t dwppDirect3DDevice9 = 0xA62C0;
constexpr uintptr_t dwRadarBase = 0x523BCB4;
constexpr uintptr_t dwSensitivity = 0xDF3B98;
constexpr uintptr_t dwSensitivityPtr = 0xDF3B98;
constexpr uintptr_t dwSetClanTag = 0x8DAB0;
constexpr uintptr_t dwViewMatrix = 0x4DF6024;
constexpr uintptr_t dwWeaponTable = 0x526388C;
...
constexpr uintptr_t m_pitchClassPtr = 0x523E308;
constexpr uintptr_t m_pStudioHdr = 0x2950;
constexpr uintptr_t m_yawClassPtr = 0xDF3928;
constexpr uintptr_t model_ambient_min = 0x5A1194;
constexpr uintptr_t set_abs_angles = 0x1EA950;
constexpr uintptr_t set_abs_origin = 0x1EA790;
} // namespace signatures
} // namespace kyedumper